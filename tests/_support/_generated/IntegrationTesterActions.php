<?php  //[STAMP] 02996ab93cb194ac4ed711a7ed43d00c
...
trait IntegrationTesterActions
{
    ...
    public function debugWpActionInitial($args = null) {
        return $this->getScenario()->runStep(new Action('debugWpActionInitial', func_get_args()));
    }
    ...
    public function debugWpActionFinal($args = null) {
        return $this->getScenario()->runStep(new Action('debugWpActionFinal', func_get_args()));
    }
}
