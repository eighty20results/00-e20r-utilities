...
use E20R\Licensing\Settings\OldLicenseSettings;
use E20R\Utilities\Utilities;
use Mockery\Mock;

class OldLicenseSettingsTest extends \Codeception\Test\Unit {
	...
	protected function setUp(): void {
		...
		Functions\expect( 'plugin_dir_path' )
			->andReturn( __DIR__ . '/../../../src/E20R/Licensing' );
	 ...
	 * @covers \E20R\Licensing\Settings\OldLicenseSettings()
	 */
	public function test_instantiate_old_license_settings( $sku, $license_settings, $server_url, $expected ) {
		...
		try {
			$settings = new OldLicenseSettings( $sku, $m_default, $m_utils );
			self::assertEquals( $expected, $settings->get( 'product_sku' ) );
			self::assertInstanceOf( OldLicenseSettings::class, $settings );
		} catch ( \Exception $e ) {
